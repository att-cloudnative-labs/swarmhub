  ...
  <div class="home">
    <section class="section">
      <div class="tile is-ancestor">
        <TestList
          :selectedTestID="id"
          :firstTestID="paginateInfo.FirstTest"
          :lastTestID="paginateInfo.LastTest"
          :firstTestIDInList="firstTestIDInList"
          :lastTestIDInList="lastTestIDInList"
          :listOfTests="listOfTests"
          @selected-test="updateSelectedTest"
          @get-tests="getTests"
          @previous-page="getPreviousPage"
          @next-page="getNextPage"
          @get-tests-fields="getTestsFields"
        />
...
export default {
  ...
  methods: {
    ...
    getPaginateInfo: function() {
      ...
      axios.get(url).then(response => (this.paginateInfo = response.data));
    },
    ...
    getTests: function(testID) {
      ...
      if (testID == "latest") {
        ...
        this.listOfTests.filter(test => test.ID === this.id).length === 1
      ) {
